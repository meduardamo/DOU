...
Mevo|Saúde|Prontuário eletrônico; dispensação eletrônica; telessaúde; assinatura digital; certificado digital; controle sanitário; prescrição por enfermeiros; doenças crônicas; autonomia da ANPD; Agência Nacional de Proteção de Dados; Acesso e uso de dados; responsabilização de plataformas digitais; regulamentação de marketplaces; LGPD e suas aplicações; segurança cibernética; inteligência artificial; marketplaces; venda online de medicamentos; digitalização do SUS; venda de medicamentos; distribuição de medicamentos; Bula digital; Interoperabilidade; ICP - Brasil; Atesta CFM; Sistemas de Controle de farmácia; SNGPC; Farmacêutico Remoto; Medicamentos Isentos de Prescrição; MIPs; RNDS; Rede Nacional de Dados em Saúde; Lista de preços CMED; Farmácia popular; Listas de Substâncias Entorpecentes, Psicotrópicas, Precursoras e outras; Substâncias sob controle especial
...
Vital Strategies|Saúde|Saúde mental; Dados para a saúde; Morte evitável; Doenças crônicas não transmissíveis; Rotulagem de bebidas alcoólicas; Educação em saúde; Bebidas alcoólicas; Metanol; Imposto seletivo; Rotulagem de alimentos; Alimentos ultraprocessados; Publicidade infantil; Publicidade de alimentos ultraprocessados; Tributação de bebidas alcoólicas; Alíquota de bebidas alcoólicas; Cigarro eletrônico; Controle de tabaco; Violência doméstica; Exposição a fatores de risco; Departamento de Saúde Mental; Hipertensão arterial; Saúde digital; Violência contra crianças; Violência contra mulheres; Feminicídio; COP 30; Inteligência artificial; Oncologia; Câncer; Neoplasia; Tumor; Tumores malignos; IA em oncologia; IA para diagnóstico de câncer; IA para tratamento oncológico; IA em detecção de tumores; Inteligência artificial em oncologia; Inteligência artificial para diagnóstico de câncer; Inteligência artificial no tratamento de câncer; Machine learning em oncologia; Machine learning para detecção de tumores; Algoritmos para diagnóstico oncológico; Algoritmos de detecção de câncer
