...
Desiderata|Saúde|obesidade infantil; obesidade infantojuvenil; obesidade na adolescência; obesidade em crianças; obesidade em adolescentes; prevenção da obesidade infantil; prevenção da obesidade infantojuvenil; sobrepeso infantil; sobrepeso e obesidade infantil; sobrepeso e obesidade em crianças e adolescentes; bebidas açucaradas; bebidas ultraprocessadas; alimentação saudável; alimentação adequada e saudável; ambiente alimentar; ambientes alimentares; ambiente alimentar saudável; ambientes alimentares saudáveis; ultraprocessado; ultraprocessados; alimentos ultraprocessados; consumo de ultraprocessados; exposição de ultraprocessados; exposição de alimentos ultraprocessados; comercialização de ultraprocessados; restrição de ultraprocessados; regulação de ultraprocessados; gôndolas de supermercados; alimentação escolar; alimentação nas escolas; Programa Nacional de Alimentação Escolar; PNAE; segurança alimentar e nutricional; alimentação hospitalar; alimentação em hospitais; alimentação saudável em hospitais; ambiente alimentar hospitalar; ambientes alimentares em hospitais; ultraprocessados em hospitais; alimentação de pacientes; hospitais federais; hospitais universitários federais; Departamento de Gestão Hospitalar; Guia Alimentar para a População Brasileira
""".strip()
