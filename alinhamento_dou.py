...
# A aba da Mevo continua na planilha, mas não recebe mais linhas nem
# classificação. As de IAS e Reúna já não existem.
...
CLIENTE_DESCRICOES = {
    ...
    "MegaEdu": (
        "MegaEdu",
        "A MegaEdu é uma organização sem fins lucrativos que atua para levar internet de alta velocidade a todas as escolas públicas do Brasil, tratando a conectividade escolar como direito e como infraestrutura básica da aprendizagem. Inspirada na EducationSuperHighway, dos Estados Unidos, articula diretores de escola, secretarias estaduais e municipais de educação, órgãos federais e empresas de telecomunicações para ampliar acesso, velocidade e infraestrutura de rede nas salas de aula, com referência de banda por aluno e de wi-fi e dispositivos disponíveis para uso pedagógico. Sua atuação se organiza em três frentes: apoio técnico a diretores para resolver problemas de conectividade; assessoria a secretarias na elaboração de planos de universalização do acesso; e assessoria técnica na formulação e no aperfeiçoamento de políticas públicas federais de conectividade, com acordo de cooperação com o Ministério da Educação firmado em 2023. Acompanha a Estratégia Nacional de Escolas Conectadas, coordenada pelos Ministérios da Educação e das Comunicações, e o financiamento e a governança da conectividade escolar, com destaque para o Fundo de Universalização dos Serviços de Telecomunicações (FUST), as decisões e editais de seu Conselho Gestor e as seleções públicas operadas pelo BNDES. Também acompanha temas correlatos como infraestrutura escolar, inclusão digital, uso de tecnologia na educação e contratação de serviços de internet pelas redes públicas de ensino. É apoiada, entre outros, por Fundação Lemann, BID, BNDES, Imaginable Futures e Brazil Foundation.",
    ),
    "Desiderata": (
        "Instituto Desiderata",
        "O Instituto Desiderata é uma organização sem fins lucrativos que atua no Rio de Janeiro desde 2003 no fortalecimento de políticas públicas em saúde e educação, com o objetivo de contribuir para o pleno desenvolvimento de crianças e jovens. Trabalha em duas frentes, câncer infantojuvenil e obesidade infantojuvenil, e o monitoramento se concentra na segunda. A frente de obesidade é voltada à prevenção e ao cuidado da obesidade na infância e na adolescência e à promoção de ambientes e hábitos alimentares adequados e saudáveis. A atuação combina produção e disseminação de conhecimento, monitoramento de dados, como o Panorama da Obesidade, campanhas de mobilização e advocacy junto ao Legislativo e ao Executivo. No ambiente escolar, articula políticas que limitam a venda e a publicidade de ultraprocessados em escolas e cantinas, com leis municipais aprovadas no Rio de Janeiro (Lei 7.987/2023) e em Niterói, e acompanha a alimentação escolar e o Programa Nacional de Alimentação Escolar (PNAE). No ambiente hospitalar, avaliou o ambiente alimentar de hospitais e publicou nota técnica sobre o ambiente hospitalar pediátrico promotor da alimentação adequada e saudável, que recomenda proibir ultraprocessados nos serviços de alimentação dos hospitais, incluindo lanchonetes e máquinas de venda. Acompanha também a alimentação oferecida a pacientes, a gestão dos hospitais federais e universitários federais e o Departamento de Gestão Hospitalar do Ministério da Saúde. Outros temas de interesse são a regulação, a comercialização e a exposição de ultraprocessados e bebidas açucaradas, inclusive em gôndolas de supermercados, a segurança alimentar e nutricional e o Guia Alimentar para a População Brasileira.",
    ),
}
